        ...
        <div className="others ">
          ...
          <div className="grid-3">
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <HiOutlineServer size={"30px"} className="icons" />
              <ul className="o-u">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <HiOutlineCalculator size={"30px"} className="icons" />
              </div>
              <ul className="o-u">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <HiCreditCard size={"30px"} className="icons" />
              </div>
              <ul className="o-u">
                <li className="o-l">Creating a Customer Centric Culture</li>
                <li className="o-l">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <HiScale size={"30px"} className="icons" />
              </div>
              <ul className="o-u">
                <li className="o-l">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <HiHome size={"30px"} className="icons" />{" "}
              </div>
              <ul className="o-u">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  Tourism and Travel Managemet
                </h3>
                  <HiBriefcase size={"30px"} className="icons" />{" "}
              </div>
              <ul className="o-u">
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <IoFastFoodSharp size={"30px"} className="icons" />
              </div>
            ...
            <div className="grid-3-cols">
              <div className="title">
                <h3 className="tertiary-header">
                  ...
                  <TbTransformFilled size={"30px"} className="icons" />
              </div>
